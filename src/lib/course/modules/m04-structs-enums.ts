...
const module: Module = {
  ...
  "description": "Crea tipos de datos personalizados con structs y enums. Domina el pattern matching y descubre Option y Result.",
  "lessons": [
    {
      "id": "m04_l01",
      "moduleId": "m04",
      ...
      "blocks": [
        {
          ...
          "problem": "Un programa real no trabaja sólo con números sueltos. Trabaja con usuarios, pedidos, puntos, libros, vuelos. Necesitas representar cosas del mundo con varios datos relacionados.",
          "mentalModel": "Un struct es una ficha con campos. En vez de cargar nombre, edad y email por separado, dices: todo esto junto representa un `Usuario`.",
          "concreteExample": "Para un viaje puedes tener `Vuelo { origen, destino, hora }`. Es más claro que pasar tres strings sueltos por todo el programa y esperar no mezclarlos.",
          "remember": "Un struct convierte datos dispersos en una idea con nombre."
        },
        {
          "type": "challenge",
        ...
        {
          "type": "quiz",
          "question": "Para modificar un campo de un struct, ¿qué necesitas hacer?",
          "options": [
            {
      ...
      "blocks": [
        {
          ...
          "problem": "Si los datos están en un lugar y las funciones que los manipulan en otro, es fácil perder el contexto. Queremos que el comportamiento natural de un tipo viva cerca del tipo.",
          "mentalModel": "Un método es una acción que pertenece a una cosa. Un `Rectangulo` sabe calcular su área porque tiene ancho y alto.",
          "concreteExample": "`usuario.nombre_completo()` se lee mejor que `nombre_completo(usuario)`, porque comunica que esa operación pertenece al concepto `Usuario`.",
          "remember": "`impl` es el lugar donde enseñas a tus tipos qué pueden hacer."
        },
        {
          "type": "faded-exercise",
          "conceptId": "m04-struct-method",
          "title": "Práctica guiada: un tipo con comportamiento",
          "intro": "Vamos a darle a un struct un método propio. Primero observa un ejemplo resuelto, luego completa los huecos, luego créalo desde cero.",
          "stages": [
            {
              "kind": "worked",
              "instructions": "**Paso 1 — observa.** `Circulo` guarda su `radio` y sabe calcular su propia `area()`. El método recibe `&self` (una referencia a sí mismo) y lee sus campos con `self.campo`.",
              "code": "struct Circulo {\n    radio: f64,\n}\n\nimpl Circulo {\n    fn area(&self) -> f64 {\n        3.14159 * self.radio * self.radio\n    }\n}"
            },
            {
              "kind": "faded",
              "instructions": "**Paso 2 — completa.** A `Rectangulo` le falta el cuerpo de `area`. Rellena los `___` para que multiplique sus dos campos.",
              "code": "struct Rectangulo {\n    ancho: u32,\n    alto: u32,\n}\n\nimpl Rectangulo {\n    fn area(&self) -> u32 {\n        self.___ * self.___\n    }\n}"
            },
            {
              "kind": "solo",
              "instructions": "**Paso 3 — tú solo.** Define `Rectangulo` con `ancho: u32` y `alto: u32`, y su método `area(&self) -> u32`.",
              "code": "struct Rectangulo {\n    // campos aquí\n}\n\nimpl Rectangulo {\n    // método area aquí\n}"
            }
          ],
        ...
        {
          "type": "quiz",
          "question": "¿Cuál es la diferencia entre una función asociada y un método en un bloque `impl`?",
          "options": [
            {
        ...
        {
          "type": "quiz",
          "question": "¿Cómo se llama a una función asociada como `Rectangulo::nuevo(10.0, 5.0)`?",
          "options": [
            {
    ...
    },
    {
      ...
      "blocks": [
        {
          "type": "first-principles",
          "title": "Enums: modelar opciones reales sin inventar estados imposibles",
          "problem": "Muchas cosas pueden estar en un conjunto limitado de estados: pendiente, pagado, cancelado. Si usas strings sueltos, puedes escribir valores inválidos por accidente.",
          "mentalModel": "Un enum es una lista cerrada de posibilidades. Rust obliga a considerar esas posibilidades al tomar decisiones.",
          "concreteExample": "Un pago no debería ser `\"pagaddo\"` por un error de tipeo. Con `enum EstadoPago { Pendiente, Pagado, Cancelado }`, ese estado imposible no compila.",
          "remember": "Los enums hacen que estados inválidos sean difíciles o imposibles de representar."
        },
        {
          "type": "challenge",
        ...
        {
          "type": "quiz",
          "question": "Qué ventaja tienen los enums de Rust sobre usar strings para representar estados?",
          "options": [
            {
